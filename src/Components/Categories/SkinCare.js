...
function SkinCare() {
    ...
    const handleSubmit = (pic,title,price,category) =>{
           ...
           fetch('http://localhost:5000/wishlist/add',{
                ...
                console.log('wish Item added  ')
                
                alert('wishItem added  Successfully')
            })
    }
...
{data.map((d) => (
  ...
  <div class="">
    ...
    <button type='button' className='btn btn-danger' data-bs-toggle="modal" data-bs-target="#exampleModal" style={{fontFamily:"cairo"}} onClick={()=>handleSubmit(d.pic,d.title,d.price,'Skincare')}>Add to WishList</button>
